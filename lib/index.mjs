...
//   - 拉取远程：镜像上游 vscode-git-graph dataSource.fetch —— remote 为空拉全部
//     （--all），prune 默认关（同上游 fetchAndPrune 默认）；超时放宽（fetch 慢网络）。
...
/** fetch 超时（毫秒）：大仓库/慢网络下 15s 不够，单独放宽（上游 fetch 无超时）。 */
