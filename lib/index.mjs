 ...
 * 返回 { ok: true, branch, fastForwarded? } 或 { ok: false, error: { code, message, paths?, moreFiles? } }。
 */
async function gitBranchAction(root, action, { branch = '', remote = '', name = '', force = false, start = '', noff = false, fastForward = '' } = {}) {
...
export function registerRoutes(ctx, { events = {} } = {}) {
  ...
  //   branch, remote, name, force, start, noff, fastForward, session }。
